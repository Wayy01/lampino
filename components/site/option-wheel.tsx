...
const DEFAULT_ITEMS = ["One", "Two", "Three", "Four", "Five"];
...
const OptionWheel = ({
  ...
  // Refs mirror the latest props synchronously (before any event/effect can
  // read them) so pointer/wheel/keyboard handlers never see stale config.
  useLayoutEffect(() => {
